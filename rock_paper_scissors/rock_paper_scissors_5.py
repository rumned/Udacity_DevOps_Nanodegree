...
class ReflectPlayer(Player):
    def move(self):
        return ReflectPlayer.learn()

    def learn(self, my_move, their_move):
        if their_move == moves[0]:
            my_move = moves[0]
            return my_move
        elif their_move == moves[1]:
            my_move = moves[1]
            return my_move
        elif their_move == moves[2]:
            my_move = moves[2]
            return my_move
...
class Game:
    ...
    def play_game(self):
        ...
        for round in range(3):  # plan to add user input to set rounds
